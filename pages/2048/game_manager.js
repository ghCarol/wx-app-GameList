...
GameManager.prototype = {
    ...
    addRandomTiles: function() {
        ...
        if (this.grid.cellsAvailable()) {
            ...
            var cell = this.grid.randomAvailableCell(); //取得的是可填充格的位置{x:0,y:0}
            var tile = new Tile(cell, value);
            this.grid.insertTile(tile); // 插入一个单元格, i.e. cells[x][y]=tile;
        }
    ...
    // 找到当前偏移方向存在最远的空单元格
    // 如：向右偏移，那么返回当前行最靠右的空单元格及其右侧距离其最近的一个格子，向下一样
